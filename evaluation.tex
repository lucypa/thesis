...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{sel4setup.pdf}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{linuxsetup.pdf}
...
While detailed analysis of these overheads is left for future work, in order to properly
